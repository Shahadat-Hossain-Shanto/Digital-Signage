...
if (!isset($_SESSION['loggedIn']) || $_SESSION['loggedIn'] !== true) {
    // Ensure you use the correct path here, e.g., /login.php
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    ...
    <!-- Include DataTables Responsive Extension CSS and JavaScript -->
  ...
  <header id="header" class="fixed-top  header-transparent">
    ...
    <div class="container d-flex align-items-center  extraSpaceBetweenMenu justify-content-between">
      ...
      <div class="logo">
        ...
        <a href="{{url('/home')}}"><img src="assets/img/2.png" alt="" class="img-fluid"><span style="color:#7393D6; font-size: 25px; font-weight:700;" >ScreenCast</span></a>
        ...
        $(document).ready(function() {
            $('#supportTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'numberOfScreen', name: 'numberOfScreen' },
                ...
                language: {
                    emptyTable: "No demo requests available",   // Message when no data
