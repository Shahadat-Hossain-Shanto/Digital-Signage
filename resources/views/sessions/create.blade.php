<x-layout titlePage="Sign In" bodyClass="bg-gray-200">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login') }}" class="text-start">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            ...
                                            {{-- <input type="email" class="form-control border border-2 p-2" name="email" value="{{ 'admin@material.com' }}"> --}}
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            ...
                                            {{-- <input type="password" class="form-control border border-2 p-2" name="password" value='{{ 'secret'}}'> --}}
