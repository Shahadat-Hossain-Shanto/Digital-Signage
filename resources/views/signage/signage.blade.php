                ...
                <div class="col-12" style="min-height: 79vh;">
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            ...
                            <div class="my-3">
                                <div class="row">
                                    <div class='col-6' style="margin-left: 0.8rem">
                                        <input type="text" id="device_id" class="form-control border border-2 p-2"
                                            placeholder="Enter device ID to view video or animation.">
                                    </div>
                                    <div class='col-6 row'>
                                        <div class='col-6'>
