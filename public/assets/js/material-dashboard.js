...
function sidebarColor(a) {
    var div_header = document.querySelector(".div-header");
    ...
    if (parent.classList.contains("bg-gradient-primary")) {
        ...
        div_header.classList.remove("bg-gradient-primary");
        div_header.classList.remove("shadow-primary");
    }
    if (parent.classList.contains("bg-gradient-dark")) {
        parent.classList.remove("bg-gradient-dark");
        div_header.classList.remove("bg-gradient-dark");
        div_header.classList.remove("shadow-dark");
    }
    if (parent.classList.contains("bg-gradient-info")) {
        parent.classList.remove("bg-gradient-info");
        div_header.classList.remove("bg-gradient-info");
        div_header.classList.remove("shadow-info");
    }
    if (parent.classList.contains("bg-gradient-success")) {
        parent.classList.remove("bg-gradient-success");
        div_header.classList.remove("bg-gradient-success");
        div_header.classList.remove("shadow-success");
    }
    if (parent.classList.contains("bg-gradient-warning")) {
        parent.classList.remove("bg-gradient-warning");
        div_header.classList.remove("bg-gradient-warning");
        div_header.classList.remove("shadow-warning");
    }
    if (parent.classList.contains("bg-gradient-danger")) {
        parent.classList.remove("bg-gradient-danger");
        div_header.classList.remove("bg-gradient-danger");
        div_header.classList.remove("shadow-danger");
    }
    parent.classList.add("bg-gradient-" + color);
    div_header.classList.add("bg-gradient-" + color);
    div_header.classList.add("shadow-" + color);
}
